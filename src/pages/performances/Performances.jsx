...
export default function Performances() {
    ...
    const Section = ({ title, icon, colorClass, plays, emptyMessage }) => {
        ...
        return (
            <div className="mb-10 md:mb-12">
                ...
                {/* Grid cards - Thêm onClick cho mỗi card */}
                {plays.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        {plays.map((performance) => (
                            <div 
                                key={performance.id} 
                                onClick={() => handleOpenPopup(performance)}
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
            ...
            <div className="mb-8 md:mb-10">
                ...
                <div className="flex items-center gap-2 text-gray-500">
                    ...
                    <p className="text-sm md:text-base">
                        {performancesdata.length} vở diễn tại Nhà hát Kịch Việt Nam
                    </p>
                </div>
            </div>
            ...
            {/* Đang diễn - Trên cùng */}
            <Section 
                title="ĐANG DIỄN"                colorClass="green"
            ...
            {/* Sắp diễn - Ở giữa */}
            <Section 
                title="SẮP DIỄN"                colorClass="orange"
            ...
            {/* Đã diễn - Dưới cùng */}
            <Section 
                title="ĐÃ DIỄN"                colorClass="gray"
                plays={classifiedPlays.past}
                emptyMessage="Chưa có vở diễn nào đã kết thúc"
            />
            ...
            <div className="mt-10 pt-6 border-t border-gray-200">
                <div className="grid grid-cols-3 gap-4 max-w-md mx-auto text-center">
                    ...
                    <div>
                        <div className="text-2xl font-bold text-gray-600">{classifiedPlays.past.length}</div>
                        <div className="text-xs text-gray-500">Đã diễn</div>
                    </div>
                </div>
            </div>

            {/* Popup chi tiết vở diễn */}
            {selectedPerformance && (
                <PerformancePopup
